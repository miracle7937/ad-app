            ...
            children: <Widget>[
              ...
              AnimatedBuilder(
                  ...
                  builder: (context, child) => Transform.scale(
                      ...
                      child: isScaled == false ? button() : Container(color: Colors.green,))),
              signUpTextRow(),
            ],
          ),
        ),
  ...
  Widget button() {
    return RaisedButton(
        ...
        child: Container(
          ...
          width: _large ? _width / 2 : (_medium ? _width / 3 : _width / 3.1),
          decoration: BoxDecoration(
            borderRadius: BorderRadius.all(Radius.circular(20.0)),
            gradient: LinearGradient(
              colors: <Color>[Colors.green[200], Colors.green],
            ),
          ),
